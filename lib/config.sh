...
load_config() {
    ...
    RSYNC_INC_RECURSIVE="${RSYNC_INC_RECURSIVE:-$DEFAULT_RSYNC_INC_RECURSIVE}"
    ...
    export SSH_TIMEOUT SSH_RETRIES RSYNC_EXTRA_OPTS RSYNC_COMPRESS RSYNC_CHECKSUM RSYNC_INC_RECURSIVE DISK_USAGE_THRESHOLD
}
