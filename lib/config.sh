...
load_config() {
    ...
    RSYNC_PARTIAL="${RSYNC_PARTIAL:-$DEFAULT_RSYNC_PARTIAL}"
    ...
    export SSH_TIMEOUT SSH_RETRIES RSYNC_EXTRA_OPTS RSYNC_COMPRESS RSYNC_PARTIAL RSYNC_CHECKSUM DISK_USAGE_THRESHOLD
}
