...
readonly GNIZA4LINUX_VERSION="0.27"
...
readonly DEFAULT_RSYNC_INC_RECURSIVE="no"
readonly DEFAULT_STALE_ALERT_HOURS=0
readonly DEFAULT_WEBHOOK_TYPE="slack"
readonly DEFAULT_NTFY_PRIORITY="default"
