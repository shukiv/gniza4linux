...
def save():
    ...
    settings = AppSettings(
        ...
        smtp_password=form.get("smtp_password") or old_data.get("SMTP_PASSWORD", ""),
        smtp_from=form.get("smtp_from", ""),
        smtp_security=form.get("smtp_security", "tls"),
        telegram_bot_token=form.get("telegram_bot_token") or old_data.get("TELEGRAM_BOT_TOKEN", ""),
        telegram_chat_id=form.get("telegram_chat_id", ""),
        webhook_url=form.get("webhook_url", ""),
        webhook_type=form.get("webhook_type", "slack"),
        ntfy_url=form.get("ntfy_url", ""),
        ntfy_token=form.get("ntfy_token") or old_data.get("NTFY_TOKEN", ""),
        ...
        digest_enabled="yes" if form.get("digest_enabled") else "no",
        digest_frequency=form.get("digest_frequency", "daily"),
        digest_time=form.get("digest_time", "08:00"),
        digest_day=form.get("digest_day", "1"),
